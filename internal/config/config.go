...
func applyServerDefaults(cfg *Config) {
	...
	if cfg.Server.IdleTimeout == 0 {
		cfg.Server.IdleTimeout = define.IdleTimeout
	}
}
...
func applyRateLimitDefaults(cfg *Config) {
	if cfg.RateLimit.Rate == 0 {
		cfg.RateLimit.Rate = define.DefaultRateLimit
	}
	if cfg.RateLimit.Window == 0 {
		cfg.RateLimit.Window = define.DefaultRateLimitWindow
	}
}
...
func applyHTTPDefaults(cfg *Config) {
	...
	if cfg.HTTP.RetryDelay == 0 {
		cfg.HTTP.RetryDelay = define.HTTPRetryDelay
	}
}
