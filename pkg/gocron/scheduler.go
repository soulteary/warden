...
// NewSchedulerWithContext creates a new scheduler with a context
...
// StartWithContext starts the scheduler with a context
// The scheduler will stop when the context is cancelled or the returned channel is closed
