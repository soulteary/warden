...
- **Migrationsleitfäden** - [Konfiguration](docs/migration-config.md), [HMAC v2](docs/migration-hmac-v2.md) und [Remote-Verschlüsselung v2](docs/migration-encryption-v2.md)
