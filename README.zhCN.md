...
> 💡 **快速开始**: 想要快速体验 Warden？查看我们的 [快速开始示例](example/README.zhCN.md)：
> - [简单示例](example/basic/README.zhCN.md) - 基础使用，仅本地数据文件
> - [复杂示例](example/advanced/README.zhCN.md) - 完整功能，包含远程 API 和 Mock 服务

### 前置要求

- Go 1.25+ (参考 [go.mod](go.mod))
- Redis (可选，用于分布式锁和缓存 - 在 ONLY_LOCAL 模式下默认禁用)
- Docker (可选，用于容器化部署)
...
> 🚀 **快速部署**: 查看 [示例目录](example/README.zhCN.md) 获取完整的 Docker Compose 配置示例
...
> 📚 **参考示例**: 查看 [示例目录](example/README.zhCN.md) 了解不同使用场景的完整示例代码和配置。
